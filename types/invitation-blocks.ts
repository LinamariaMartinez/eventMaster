...
export function getDefaultBlocks(eventType: EventType): BlockConfig[] {
  ...
  const eventSpecificBlocks: Record<EventType, BlockConfig[]> = {
    wedding: [
      ...
      { type: 'faq', enabled: true, order: 9 },
    ],
    birthday: [
      { type: 'story', enabled: true, order: 1 },
      { type: 'timeline', enabled: true, order: 3 },
      { type: 'gallery', enabled: true, order: 4 },
      { type: 'menu', enabled: true, order: 6 },
      { type: 'gifts', enabled: true, order: 7 },
      { type: 'dresscode', enabled: true, order: 8 },
      { type: 'faq', enabled: true, order: 9 },
    ],
    corporate: [
      ...
      { type: 'story', enabled: false, order: 7 },
      { type: 'gifts', enabled: false, order: 8 },
      { type: 'dresscode', enabled: false, order: 9 },
    ],
  };
